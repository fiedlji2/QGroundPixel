...
public class QGCLogger {
    ...
    private static final boolean DEBUG = false; // QGroundPixel: BuildConfig lives in the applicationId package (org.qgroundpixel.app), not in this class's package - avoid the cross-package reference
