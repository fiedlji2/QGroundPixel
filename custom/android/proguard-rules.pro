...
# --- QGroundPixel WFB-NG: classes reached only via JNI/reflection ---
-keep class org.mavlink.qgroundcontrol.wfb.** { *; }
-keep class com.openipc.wfbngrtl8812.** { *; }
-keep class com.openipc.videonative.** { *; }
